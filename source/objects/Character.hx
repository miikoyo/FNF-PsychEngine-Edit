...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = 'bf', ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			default:
				var characterPath:String = 'characters/$curCharacter/' + curCharacter + '.json'; // this probably sucks but whatever
				...
				#end
				{
					path = Paths.getPreloadPath('characters/$DEFAULT_CHARACTER/' + DEFAULT_CHARACTER + '.json'); //If a character couldn't be found, change him to BF just to prevent a crash
				}
